...
void zenon::create_cmd_list()
{
    ...
    if (!resnet)
    {
        ...
        //number_of_kernels = 0;
            ...
            submit_kernel_to_cmd_list(mem_bound_kernel, { input1_buffer, input2_buffer }, im_buf1, kernel_ts_event[16], { &kernel_ts_event[15], &kernel_ts_event[12] }, 2, 700);        //->res3b_branch2a
            submit_kernel_to_cmd_list(cmp_bound_kernel, { input1_buffer, input2_buffer }, im_buf1, kernel_ts_event[17], { &kernel_ts_event[16] }, 1, 603);                              //->res3b_branch2b
            submit_kernel_to_cmd_list(mem_bound_kernel, { input1_buffer, input2_buffer }, im_buf1, kernel_ts_event[18], { &kernel_ts_event[17] }, 1, 1330);                             //->res3b_branch2c
            submit_kernel_to_cmd_list(mem_bound_kernel, { input1_buffer, input2_buffer }, im_buf1, kernel_ts_event[19], { &kernel_ts_event[18] }, 1, 700);                              //->res3c_branch2a
            ...
            submit_kernel_to_cmd_list(mem_bound_kernel, { input1_buffer, input2_buffer }, im_buf1, kernel_ts_event[21], { &kernel_ts_event[20] }, 1, 1330);                             //->res3c_branch2c
            ...
            SUCCESS_OR_TERMINATE(zeCommandListCreate(context, device, &output_copy_command_list_descriptor, &output_copy_command_list));
            SUCCESS_OR_TERMINATE(zeCommandListAppendMemoryCopy(output_copy_command_list, output->data(), output_buffer, allocSize, nullptr, 1, &kernel_ts_event[21]));
            SUCCESS_OR_TERMINATE(zeCommandListClose(output_copy_command_list));
